...
class CategoryController extends AbstractController
{
    ...
    public function articleByCategory(BlogPostApiClient $apiClient,string $category): Response
    {
        ...
        return $this->render('index/index.html.twig', [
            'articles' => $articles2, 'category' => $articles2[0]->getCategorisation(), 'pagination' => $articles->getPagination()
        ]);
    }
    ...
    {
        $articles=$apiClient->getPostByCategoryFr($category,1,5);
        $articles2=$articles->getData();
    ...
    public function articleByCategory2(BlogPostApiClient $apiClient,$page,string $category): Response
    {
        $articles=$apiClient->getPostByCategory($category,$page,5);
        $articles2=$articles->getData();
    ...
    public function articleByCategorFr2(BlogPostApiClient $apiClient,$page,string $category): Response
    {
        $articles=$apiClient->getPostByCategoryFr($category,$page,5);
        $articles2=$articles->getData();
